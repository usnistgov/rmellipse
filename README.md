...
1. RMEMeas and RMEProp for correlated uncertainty propagation using [XArray](https://docs.xarray.dev/en/stable/).

2. AnnotatedArray to define xarray.DataArray structure specifications.

3. GroupSaveable for serializing heirarchical objects to [HDF5](https://www.hdfgroup.org/solutions/hdf5/).
